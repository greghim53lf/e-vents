  ...
  return (
    <>
      <section className="flex justify-center bg-primary-50">
        <div className="grid md:grid-cols-2 2xl:max-w-7xl wrapper items-center">
          <div className="relative w-full h-[300px] md:h-full md:max-h-[400px] flex-center">
            <Image
              src={event.imageUrl}
              alt="event image"
              fill
              className="absolute inset-0 object-cover object-center rounded-3xl"
            />
          </div>
          ...
          <div className="flex w-full flex-col gap-8 p-5 md:p-10">
            <div className="flex flex-col gap-6">
              ...
              <div className="flex flex-col gap-3 md:flex-row md:items-center">
                ...
                <p className="p-medium-18 ml-2 mt-2 md:mt-0">
                  by{" "}
